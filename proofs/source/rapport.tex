...
Ainsi,
\[
    1 - I_{d_i^l + t}(in/10 + \alpha, n - in/10 -  \alpha + 1) \leq \exp\left( - 2\dfrac{k^2}{n} \right)\exp\left( -2np^2 + 4pk \right).
\]

De plus,
\begin{align*}
    \int_0^{d_i^l}\exp\left( -2np^2 + 4pk \right)\dt = \int_{d_i^l}^{{2d_i^l}}\exp\left( -2nt^2 + 4tk \right)\dt t \leq \int_{\R}\exp\left( -2nt^2 + 4tk \right)\dt t.
\end{align*}

On a alors,
\[
    \int_0^{d_i^l}\exp\left( -2np^2 + 4pk \right)\dt \leq  \int_{\R}\exp\left( -2n\left(t - \dfrac{k}{n}\right)^2 + 2 \dfrac{k^2}{n} \right)\dt t = \dfrac{1}{\sqrt{2n}}\exp\left( 2 \dfrac{k^2}{n} \right) \int_{\R}\exp\left( -t^2 \right)\dt t.
\]

Enfin,
\[
    \int_0^{d_i^l}\exp\left( -2np^2 + 4pk \right)\dt \leq \sqrt{\dfrac{\pi}{2n}}\exp\left( 2 \dfrac{k^2}{n} \right).
\]
