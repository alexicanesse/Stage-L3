...
La \textit{differential privacy} \cite{10.1007/11681878_14} quantifie la perte de confidentialité subit par un individue en participant à une étude. \\
...
\begin{remark}
    ...
    Les valeurs de \(n\) possibles sont alors raisonnable. Par exemple, pour \(\varepsilon = 1\) nous avons \(n \geq 905\).
\end{remark}
