...
\begin{figure}[H]
    \centering
    \subfloat[\(\varepsilon = 0.5\)]{\centering \includegraphics[width=.3\textwidth]{"./proofs/NXtRAr1Wzm2ojG6R_0.500000.pdf"}}
    \hfill
    \subfloat[\(\varepsilon = 1\)]{\centering \includegraphics[width=.3\textwidth]{"./proofs/NXtRAr1Wzm2ojG6R_1.000000.pdf"}}
    \hfill
    \subfloat[\(\log-\log\) : \(\varepsilon = 1\)]{\centering \includegraphics[width=.3\textwidth]{"./proofs/NXtRAr1Wzm2ojG6R_1.000000_log_log.pdf"}}
